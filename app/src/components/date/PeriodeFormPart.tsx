 ...
 *
 * ## Feilhåndtering
 * Feilhåndtering delegeres til DatePickerFormPart, som leser valideringsfeil
 * direkte fra react-hook-form sin errors-state for hvert enkelt felt (fraDato/tilDato).
 * Dette inkluderer både "påkrevd"-feil og kryssfelt-feil (f.eks. "tilDato må være etter fraDato")
 * fra periodeSchema sin .refine()-validering.
 *
 * @example
 * <PeriodeFormPart
