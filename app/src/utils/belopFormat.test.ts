...
describe("formaterBelop (ren visning, locale-styrt)", () => {
  it("grupperer med mellomrom for nb og nn", () => {
    expect(formaterBelop("1234567", "nb")).toBe("1\u{A0}234\u{A0}567");
    expect(formaterBelop("1234567", "nn")).toBe("1\u{A0}234\u{A0}567");
  });
  ...
  it("faller tilbake til nb-format for ukjent språk", () => {
    expect(formaterBelop("1234", "se")).toBe("1\u{A0}234");
  });
