...
const SKJEMA_DEFINISJON_A1_V2_NB = {
...
const SKJEMA_DEFINISJON_A1_V2_NN = {
  type: "UTSENDT_ARBEIDSTAKER",
  versjon: "2",
  seksjoner: {
    utsendingsperiodeOgLand: {
...
const SKJEMA_DEFINISJON_A1_V2_EN = {
  type: "UTSENDT_ARBEIDSTAKER",
  versjon: "2",
  seksjoner: {
    utsendingsperiodeOgLand: {
...
export const SKJEMA_DEFINISJONER_A1_V2 = {
  nb: SKJEMA_DEFINISJON_A1_V2_NB,
  nn: SKJEMA_DEFINISJON_A1_V2_NN,
  en: SKJEMA_DEFINISJON_A1_V2_EN,
} as const;

export type SupportedLanguage = keyof typeof SKJEMA_DEFINISJONER_A1_V2;
...
export const SKJEMA_DEFINISJON_A1_V2 = SKJEMA_DEFINISJON_A1_V2_NB;

// Typer inferert fra konstanten
export type SkjemaDefinisjonA1_V2Type = typeof SKJEMA_DEFINISJON_A1_V2_NB;
export type SeksjonsNavn = keyof typeof SKJEMA_DEFINISJON_A1_V2_NB.seksjoner;
export type FeltNavn<S extends SeksjonsNavn> =
  keyof (typeof SKJEMA_DEFINISJON_A1_V2_NB.seksjoner)[S]["felter"];
...
): SkjemaDefinisjonA1_V2Type {
  return SKJEMA_DEFINISJONER_A1_V2[
    lang
  ] as unknown as SkjemaDefinisjonA1_V2Type;
}
...
export function getFeltForLang<S extends SeksjonsNavn>(
  ...
  const definisjon = SKJEMA_DEFINISJONER_A1_V2[
    lang
  ] as unknown as SkjemaDefinisjonA1_V2Type;
