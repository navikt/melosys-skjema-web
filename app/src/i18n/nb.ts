export const nb = {
  translation: {
    ...
    oversiktFelles: {
      ...
      historikkKolonneSaksnummer: "Saksnummer",
      ...
      historikkStatusFerdigBehandlet: "Ferdig behandlet",
      historikkStatusBeggeDelerMottatt: "Begge deler mottatt",
      historikkStatusVenterArbeidstakersDel: "Venter på arbeidstakers del",
      historikkStatusVenterArbeidsgiversDel: "Venter på arbeidsgivers del",
      historikkStatusKomplettSoknadMottatt: "Komplett søknad mottatt",
