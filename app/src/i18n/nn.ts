  ...
  translation: {
    felles: {
      ...
      utkastReinitialisert:
        "Skjemaet er oppdatert, så tidlegare svar og vedlegg er fjerna. Ver venleg og fyll ut søknaden på nytt.",
      ...
      stegManglerUtfylling:
        "Du må fylle ut følgjande steg før du kan sende inn søknaden",
      feilVedInnsending:
        "Det oppstod ein feil ved innsending av søknaden. Prøv igjen på eit seinare tidspunkt.",
    ...
    soknadHeader: {
      soknadForUtsendtArbeidstakerInnenEuEosOgSveits:
        "Søknad om A1 for utsende arbeidstakarar i EØS eller Sveits",
      bekreftelseFraArbeidsgiver:
        "Stadfesting frå arbeidsgivar på utsending til anna EØS-land eller Sveits",
    },
    landVelgerFormPart: {
      velgLand: "Vel land",
    },
    ...
    familiemedlemmerSteg: {
      ...
      infokortTittel: "Medfølgande familiemedlemmar",
    ...
    vedleggSteg: {
      ...
      feilVedHentingAvVedlegg: "Kunne ikkje hente vedlegg. Prøv igjen seinare.",
      feilVedSlettingAvVedlegg: "Kunne ikkje slette vedlegget. Prøv igjen.",
      feilTomFil: "Fila er tom.",
      feilMaksAntallVedlegg: "Maks tal på vedlegg (10) er nådd.",
    },
    ...
    skatteforholdOgInntektSteg: {
      ...
      duMaVelgeHvilketLandSomUtbetalerPengestotten:
        "Du må velje kva for land som utbetaler pengestøtta",
    ...
    arbeidsstedIUtlandetSteg: {
      ...
      sokkelLandErPakrevd: "Du må velje kva for lands sokkel dette er",
      ...
      territorialfarvannLandErPakrevd:
        "Du må velje kva for lands territorialfarvatn skipet seglar i",
      hjemmebaseLandErPakrevd:
        "Du må velje kva for land arbeidstakaren har heimebase i",
      ...
      vanligHjemmebaseLandErPakrevd:
        "Du må velje kva for land den vanlege heimebasen ligg i",
    ...
    utenlandsoppdragetSteg: {
      ...
      duMaVelgeHvilketLandArbeidstakerenSendesTil:
        "Du må velje kva for land arbeidstakaren blir sendt til",
    ...
    utsendingsperiodeOgLandSteg: {
      ...
      arbeidsgiverOppgaPeriode:
        "Arbeidsgivaren din oppgav perioden {{fraDato}}–{{tilDato}}",
    },
    ...
    landingsside: {
      ...
      soknadVenterPaaDeg: "Søknad ventar på deg",
      avbryt: "Avbryt",
    },
    appHeader: {
    ...
    oversiktDegSelv: {
      ...
      ettersendelse:
        "Du kan ikkje ettersende dokumentasjon her. Du kan anten sende ein ny søknad med vedlegg eller sende dokumentasjonen via ",
      ettersendelseLenke: "Send dokument til Nav",
    ...
    oversiktArbeidsgiver: {
      ...
      ettersendelse:
        "Du kan ikkje ettersende dokumentasjon her. Ettersendte dokument kan sendast i ein ny søknad som vedlegg.",
    },
    oversiktRadgiver: {
      tittel: "Oversiktsside for søknader",
      herKanDu: "Her kan du:",
    ...
    oversiktFelles: {
      ...
      feilVedHentingAvFullmakter:
        "Det oppstod ein feil ved henting av personar du har fullmakt for. Prøv igjen seinare.",
      ...
      historikkStatusAvsluttet: "Avslutta",
      historikkStatusSoknadMottatt: "Søknad motteken",
      historikkStatusVenterArbeidstakersDel: "Ventar på arbeidstakaren sin del",
      historikkStatusVenterArbeidsgiversDel: "Ventar på arbeidsgivaren sin del",
