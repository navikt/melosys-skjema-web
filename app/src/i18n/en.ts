export const en = {
  translation: {
    ...
    oversiktFelles: {
      ...
      historikkKolonneSaksnummer: "Case number",
      ...
      historikkStatusFerdigBehandlet: "Processing completed",
      historikkStatusBeggeDelerMottatt: "Both parts received",
      ...
      historikkStatusKomplettSoknadMottatt: "Complete application received",
      orgnrLabel: "Org. no:",
